...
public class PhotoLibraryViewController: UIViewController {
    ...
    private func onFailure(_: NSError) {
...
extension PhotoLibraryViewController: UICollectionViewDataSource {
    ...
    @objc(collectionView:willDisplayCell:forItemAtIndexPath:) public func collectionView(_: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
